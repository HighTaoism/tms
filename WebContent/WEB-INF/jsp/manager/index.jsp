    	...
    	<div class="centent">
        	<div class="left">
            	<ul class="baseUI">
                    ...
                    <em class="base_userset"></em><span>栏目管理</span></a></li>
                    
                    <li url="toAddMusic.action"><a href="#">
                    <em class="base_roll"></em><span>音乐发布</span></a></li>
                    
                    <li url="toMusicManager.action"><a href="#">
                    <em class="base_sys"></em><span>音乐管理</span></a></li>
                </ul>
            </div>
            <div class="right">
            <!-- 这是内容区域 -->
